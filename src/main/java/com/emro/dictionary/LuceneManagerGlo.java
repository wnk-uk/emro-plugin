...
public class LuceneManagerGlo {

    // 싱글톤 인스턴스
    private static LuceneManagerGlo instance;
    ...
    // private 생성자 (싱글톤)
    private LuceneManagerGlo() throws IOException {
    ...
    // 싱글톤 인스턴스 반환
    public static synchronized LuceneManagerGlo getInstance() throws IOException {
        if (instance == null) {
            instance = new LuceneManagerGlo();
        }
        return instance;
    }
